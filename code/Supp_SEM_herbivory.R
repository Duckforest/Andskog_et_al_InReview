...
Haiti.SEM_near = psem(
  ...
  lme(Shoot.growth ~ Seagrass.P + Seagrass.N + SLA + Seagrass.C13 + Bites.area, 
      random=~1|Reef/Distance, na.action = na.omit, data=Haiti_near),
  
  lme(C.production ~ Seagrass.P + Seagrass.N + SLA + LAI + Seagrass.C13 + Bites.area, 
      random=~1|Reef/Distance, na.action = na.omit, data=Haiti_near),
...
Haiti.SEM_near2 = psem(
  ...
  lme(C.production ~ Seagrass.P + LAI + Seagrass.C13 + Bites.area, 
      random=~1|Reef/Distance, na.action = na.omit, data=Haiti_near),
